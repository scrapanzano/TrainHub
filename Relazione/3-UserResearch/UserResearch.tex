...
\subsection{Research Approach}\label{subsect:UR_Introduction}
Following the market and competitor analysis, the next fundamental step in the design process of TrainHub was conducting comprehensive User Research. Engaging directly with potential users allowed us to understand their real needs, daily habits, and primary frustrations.
...
\include{3-UserResearch/QuestionnaireResults}
\include{3-UserResearch/AffinityDiagram}
\include{3-UserResearch/Personas}
\include{3-UserResearch/Scenarios}
