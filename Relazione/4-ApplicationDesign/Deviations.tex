...
\begin{itemize}
    ...
    \item \textbf{Notification centre:} the early bell opened chat and counted unread messages only. The final design adds one persistent notification list for messages, appointments, workout plans, and nutrition plans, with filters and explicit read or delete actions;
