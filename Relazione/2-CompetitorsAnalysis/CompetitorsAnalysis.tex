...
According to the theory, we divided the analyzed applications into two main categories:
\begin{itemize}
...
\include{2-CompetitorsAnalysis/DirectCompetitors}
\include{2-CompetitorsAnalysis/IndirectCompetitors}

\subsection{Conclusion}\label{subsect:CompetitorsConclusion}
